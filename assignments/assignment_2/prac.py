...
def MNB_valid(sentence, pos_CP, neg_CP, train_pos_prob, train_neg_prob):
        ...
        pos_pow_list = [ n * math.log(wi) for wi, n in zip(pos_CP, word_count)]
        pos_pow_list = list(filter((0.0).__ne__, pos_pow_list))

        neg_pow_list = [ n * math.log(wi) for wi, n in zip(neg_CP, word_count)]
        ...
        pos_res = math.log(train_pos_prob) +  multiply(pos_pow_list)
        #pos_res = multiply(pos_pow_list)
        print(pos_res)
        ...
        neg_res = math.log(train_neg_prob) + multiply(neg_pow_list)
        #neg_res = multiply(neg_pow_list)
        print(neg_res)
